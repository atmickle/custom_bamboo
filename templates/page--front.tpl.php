...
<div class="container" id="content-top-custom">
  <div class="page">
...
<div class="container" id="content-wrapper">
  <div class="strip" id="pubregion">
    <div class="page">
      <div id="author-pubs" class="strip">
        <div class="page">
          <h3>This week's Woods Hole Publications</h3>
            <div id="pub-box" class="hp-section">
              <?php $view = views_get_view('author_works');
                   print $view->execute_display('default');
                //$view2 = views_get_view('species_pubs');
                //print $view2->execute_display('default');
              ?>
                <!-- <div id="pub-tabs">
                <a id="auth-tab" class="active-pubs">This week's publications by Woods Hole authors</a>
  ...
  <div id="announcements" class="strip">
	...
	<div id="announcements-box" class="hp-section">
          <?php $view = views_get_view('announcements');
		print $view->execute_display('default'); ?>
	</div>
    </div>
  </div> 
  ...
  <div id="main" class="strip">
    <div class="page">
      ...
      <?php endif; ?>
        ...
        <div id="content" class="<?php print $contentwid; ?> columns hp-section">
